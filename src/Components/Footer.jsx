      ...
      >
        ...
        <div className="opacity-0 group-hover:opacity-100 translate-x-2 group-hover:translate-x-0 transition-all duration-200 pointer-events-none">
          <div className="bg-stone-900 border border-white/10 text-white text-xs font-semibold px-3 py-2 rounded-xl shadow-xl whitespace-nowrap">
            Chat with us
            <div className="absolute right-[-5px] top-1/2 -translate-y-1/2 w-2.5 h-2.5 bg-stone-900 border-r border-t border-white/10 rotate-45" />
          </div>
        </div>
        ...
        >
          ...
          <div className="relative w-full h-full rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] shadow-lg shadow-[#25D366]/30 flex items-center justify-center hover:scale-110 transition-transform duration-200">
